...
function buildgameboard(height: number,player: string) {
...
function buildbox(player:string,i:number,j:number) {
...
// create player ships
let shipcount = 0
let shiptaken:number[] = []
function ships(e: any) {
...
function computershiptest(currentrandom:number , position:number ) {
